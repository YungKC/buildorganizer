				...
				if (result[i] == parts[0]) {
					if (i == 0) {
						for (var j=1; j<result.length; j++) {
							if (result[j] == parts[1]) {
								console.log("found circular dependency for " + parts[1])
								return null;
							}
						}
						...
						console.log("found multiple dependencies for " + parts[0])
						return null
					}
				}
				if (result[i] == parts[1]) {
					if (i == result.length-1) {
						for (var j=0; j<result.length-1; j++) {
							if (result[j] == parts[0]) {
								console.log("found circular dependency for " + parts[0])
								return null
							}
						}
						result.push(parts[0])
						...
						console.log("found multiple dependencies for " + parts[1])
						return null
					}
				}
			}
